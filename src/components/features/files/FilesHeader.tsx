 ...
 * Displays page header with navigation and title for files page
 */
...
export const FilesHeader = memo(function FilesHeader() {
  return (
        ...
        <div className="flex items-center gap-3 w-full flex-wrap sm:flex-nowrap">
          ...
          <div className="flex items-center gap-2 xs:gap-3 min-w-0 flex-1">
            ...
            <div className="min-w-0 flex-1">
              <h1 className="text-xl xs:text-2xl sm:text-3xl font-bold leading-tight bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent break-words">
                My QR Codes
              </h1>
